...
public class PlayerStateMachine : StateMachine
{
    ...
    [field: SerializeField] public ForceReceiver ForeceReceiver { get; private set; } // 중력 제어

    [field: SerializeField] public Animator Animator { get; private set; } // 애니메이터
    [field: SerializeField] public Targeter Targeter { get; private set; } // 타겟터
    [field: SerializeField] public float FreeLookMovementSpeed { get; private set; } // 기본 이동속도

    [field: SerializeField] public float TargetingMovementSpeed { get; private set; } // 타겟 스테이트 이동속도
